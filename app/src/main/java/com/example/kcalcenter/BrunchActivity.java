...
public class BrunchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FoodAdapter foodAdapter = new FoodAdapter(BrunchActivity.this,R.layout.listview_food,foods);
        ...
        btnLunchAddFood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                foodAdapter.notifyDataSetChanged();
                Intent intent = new Intent(BrunchActivity.this,MainActivity.class);
